...
ALTER DEFAULT PRIVILEGES IN SCHEMA studio, jublawoma, unclet, zelglihof, oliumbi GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO studio;
ALTER DEFAULT PRIVILEGES IN SCHEMA queue GRANT SELECT, INSERT ON TABLES TO studio;

GRANT USAGE ON SCHEMA queue, oliumbi TO oliumbi;
ALTER DEFAULT PRIVILEGES IN SCHEMA oliumbi GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO oliumbi;
ALTER DEFAULT PRIVILEGES IN SCHEMA queue GRANT SELECT, INSERT ON TABLES TO oliumbi;

GRANT USAGE ON SCHEMA queue, jublawoma TO jublawoma;
ALTER DEFAULT PRIVILEGES IN SCHEMA jublawoma GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO jublawoma;
ALTER DEFAULT PRIVILEGES IN SCHEMA queue GRANT SELECT, INSERT ON TABLES TO jublawoma;

GRANT USAGE ON SCHEMA queue, unclet TO unclet;
ALTER DEFAULT PRIVILEGES IN SCHEMA unclet GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO unclet;
ALTER DEFAULT PRIVILEGES IN SCHEMA queue GRANT SELECT, INSERT ON TABLES TO unclet;

GRANT USAGE ON SCHEMA queue, zelglihof TO zelglihof;
ALTER DEFAULT PRIVILEGES IN SCHEMA zelglihof GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO zelglihof;
ALTER DEFAULT PRIVILEGES IN SCHEMA queue GRANT SELECT, INSERT ON TABLES TO zelglihof;
