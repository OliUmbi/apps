	...
	const services = [
		{
			name: "Pflanzenschutz",
			description:
				"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent interdum lacus in neque lobortis, quis vehicula massa accumsan. Morbi vel pretium ipsum. Nunc sed nulla nec ipsum commodo porta ac nec enim. Suspendisse ut massa libero.",
		...
		<div className="flex flex-col max-w-5xl m-auto">
			...
			<div className="flex flex-col gap-8 p-4">
				{services.map((service) => (
					<div
						className="overflow-hidden bg-stone-200 rounded-lg grid grid-cols-1 md:grid-cols-2 border border-stone-300 shadow-lg"
						key={service.name}
					>
						<img
							src={service.image}
						...
						<div className="p-4 flex flex-col justify-between gap-4">
							...
							<Link
								to="/contact"
								className="px-3 py-2 bg-green-400 border border-green-500 rounded-md text-sm font-semibold"
							>
								Kontakt aufnehmen
							</Link>
						</div>
