...
> = {
	"jublawoma.story": [
		{
			resourceId: "jublawoma.story_image",
			foreignKey: "story_id",
		},
	],
	"jublawoma.donation": [
		{
			resourceId: "jublawoma.donation_item",
	...
	"unclet.showcase": [
		{
			resourceId: "unclet.showcase_image",
			foreignKey: "showcase_id",
		},
	],
	"zelglihof.article": [
		{
			resourceId: "zelglihof.article_image",
			foreignKey: "article_id",
		},
	],
	"zelglihof.product": [
		{
			resourceId: "zelglihof.product_variant",
